...
<html>
    <head>
        ...
        <title>Flexarloeren : Your request has been accepted!</title>
        <meta property="og:title" content="Flexarloeren : Your request has been accepted!" />
        <meta property="og:image" content="logo-main.png"/>
        
        <meta property="og:description" content="Flexarloeren : Your request has been accepted!">
        <meta name="description" content="Flexarloeren : Your request has been accepted!">
...
<style>
	* {
	...
	.bodyClass1-catalogeu--field{
		background: #f9f3f3;
		color: #ffffff;
	}
	.bodyClass2-catalogeu--field{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-catalogeu--field{
		background: #fff;
		color: #111;
	}
	.wrapage-block-catalogeu--field{
		background-size: 100%;
		width: 100%;
	}
	.box_main-catalogeu--field{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-catalogeu--field h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-catalogeu--field p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-catalogeu--field{
		text-align: start;
	}
	.mainBlock-catalogeu--field ul{
		text-align: start;
		padding: 20px;
		display: flex;
	...
	.mainBlock-catalogeu--field ul>li span{
		font-weight: bold;
	}
	.mainBlock-catalogeu--field{
		max-width: 876px;
	...
	.mainBlock-catalogeu--field .cBlock-catalogeu--field{
		text-align: start;
	}

	.bodyClass3-catalogeu--field .mainBlock-catalogeu--field{
		background: none;
		border-top: 2px dotted #bbbbbb;
		border-bottom: 2px dotted #bbbbbb;
	}
	.bodyClass2-catalogeu--field .mainBlock-catalogeu--field{
		background: #161616;
		color: #fff !important;
		box-shadow: 0px 0px 0px #161616;
	}
	.bodyClass2-catalogeu--field .mainBlock-catalogeu--field p{
		color: #fff !important;
	}
	.bodyClass1-catalogeu--field .mainBlock-catalogeu--field{
		background: #5E1030;
		color: #ffffff;
		border-left: 2px solid #0A91AB;
	}
	.bodyClass1-catalogeu--field .mainBlock-catalogeu--field p{
		color: #ffffff !important;
	}
	.order-catalogeu--field{
...
<div class="bodyClass1-catalogeu--field" id="mainWrapp-catalogeu--field">


	<div class="wrapage-block-catalogeu--field">
		<div class="box_main-catalogeu--field">
			<div class="mainBlock-catalogeu--field">
...
<p class="cBlock-catalogeu--field">Warmest regards, The Team!</p>
			</div>
		</div>
	</div>
